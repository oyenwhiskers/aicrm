...
return [
    ...
    */
    ...
    'gemini' => [
        ...
        'global_concurrency' => (int) env('GEMINI_GLOBAL_CONCURRENCY', 2),
        'slot_lease_seconds' => (int) env('GEMINI_SLOT_LEASE_SECONDS', 240),
        'slot_requeue_seconds' => (int) env('GEMINI_SLOT_REQUEUE_SECONDS', 3),
        'document_preprocess_max_dimension' => (int) env('GEMINI_DOCUMENT_PREPROCESS_MAX_DIMENSION', 2200),
        'document_preprocess_size_threshold_bytes' => (int) env('GEMINI_DOCUMENT_PREPROCESS_SIZE_THRESHOLD_BYTES', 2097152),
        'document_preprocess_jpeg_quality' => (int) env('GEMINI_DOCUMENT_PREPROCESS_JPEG_QUALITY', 82),
        'document_preprocess_webp_quality' => (int) env('GEMINI_DOCUMENT_PREPROCESS_WEBP_QUALITY', 82),
        'document_preprocess_png_compression' => (int) env('GEMINI_DOCUMENT_PREPROCESS_PNG_COMPRESSION', 6),
